...
Before starting, include the following lines of code at the top of your script to load the package.
...
```{r exampleObject1}
example.object <- dataframeToExperiment(raw_data =  example, time_index = 1,
